                      ...
                      <div className="p-4 space-y-1">
                        <div className="flex flex-row space-x-2 items-center">
                          <svg className="w-8 h-8 mt-1" xmlns="http://www.w3.org/2000/svg" data-name="Layer 51" viewBox="0 0 100 125" x="0px" y="0px">
                            ...
                            <h3 className="text-lg font-semibold">Begin your journey with brand voices.</h3>
                        </div>
                        <div>
                            <div className="text-sm text-gray-600 font-normal">Utilizing voices empowers AI model to adopt your brand's unique tone and style. Simplify the process of writing like yourself by incorporating voices in chat, documents, and templates.</div>
                        </div>
                      </div>
                  </div>
                </div>
                            ...
                            <thead className="bg-gray-50">
                              <tr>
                                  <th scope="col" className="px-3 py-3.5 text-left text-xs font-semibold text-gray-700 uppercase">
                                    <button className="group inline-flex items-center uppercase">
                                        Voice
                                    </button>
                                  </th>
                            ...
                            <tr>
                                <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-700 cursor-pointer">
                                  <div className="flex flex-row items-center space-x-2">
                                      <p className="text-sm text-gray-900 font-normal">{data.brand_voice}</p>
      
                                      {/* <button className="tooltip-container group inline-block relative cursor-pointer">
                                      <svg className="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
                                            <path d="M2.42,12.96c2.57,3.01,8.6,3.01,11.17,0,2.36-2.77,2.18-8.21-.66-10.58C10.38,.26,5.62,.26,3.08,2.38,.23,4.76,.05,10.19,2.42,12.96Z" fill="none" stroke="#9CA3AF" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"></path>
                                            <path d="M6.57,7.17h1.71v3.96" fill="none" stroke="#9CA3AF" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"></path>
                                            <path d="M6.58,11.13h3.4" fill="none" stroke="#9CA3AF" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"></path>
                                            <path d="M8.29,4.25v.37" fill="none" stroke="#9CA3AF" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"></path>
                                        </svg>
                                        <span className="tooltip-text inline-block whitespace-normal break-words">
                                          {data.content_summarize.slice(0,10)}
                                        </span>
                                ...
                                <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-700">
                                  <div className="flex justify-end space-x-10 mr-2">
                                      <button type="button" className="transition-all duration-200 relative font-semibold shadow-sm hover:outline-none focus:outline-none px-2 py-1 text-xs text-center bg-transparent focus:ring-transparent rounded outline-none shadow-transparent" aria-label="Edit"
                                      onClick={()=>{
                                      ...
                                      <button type="button" className="transition-all duration-200 relative font-semibold shadow-sm hover:outline-none focus:outline-none px-2 py-1 text-xs text-center bg-transparent focus:ring-transparent rounded outline-none shadow-transparent" aria-label="Delete"
                                       onClick={()=>{
                                                ...
                                                <div className=" flex items-center justify-center flex-col mt-2 text-center sm:ml-4 sm:text-left">
                                                    ...
                                                    <div className="items-center gap-2 mt-3 sm:flex">
                                                        <button
                                                            ...
                                                            onClick={() =>{
                                                              // console.log(DeleteBrandVoiceId)
                                                              const formData = {
                                                                trash: true
                                                              }
              ...
              {/* <div className="mt-4 mb-28">
                <div className="space-y-3">
                    <div className="flex flex-row justify-between items-center gap-8">
                      <div className="text-sm text-gray-400">1 — 1 of 1</div>
                      <div className="flex justify-between items-center">
                          <button className="w-8 h-8 p-1 rounded-lg text-gray-400 opacity-75 hover:bg-transparent active:bg-transparent" disabled="">
                            <span>
                          ...
                          <button disabled="" className="w-8 h-8 p-1 rounded-lg text-base font-semibold bg-blue-600 text-white hover:bg-blue-600 active:bg-blue-600">1</button>
                          <button className="w-8 h-8 p-1 rounded-lg text-gray-400 opacity-75 hover:bg-transparent active:bg-transparent" disabled="">
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" aria-hidden="true" className="w-5 h-5">
