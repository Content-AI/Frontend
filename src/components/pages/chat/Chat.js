...
const Chat = ({ AUTH_TOKEN }) => {
  ...
  return (
    <div className="w-full flex-grow flex flex-col h-[calc(100vh-122px)] items-center overflow-hidden">
      <div className="relative flex flex-col overflow-hidden h-full w-full bg-white grow max-w-[832px]">
        <div className="flex flex-col flex-auto h-full w-full">
          ...
          <div className="flex flex-col w-full py-2 px-4 @lg:py-4 max-w-7xl m-auto">
                  ...
                  {tagList.map((item, index) => {
                    return (
                      <span
                        ...
                        onClick={(e) =>
                          setChatFill(e.currentTarget.textContent)
                        }
                      >
                        {item}
                      </span>
