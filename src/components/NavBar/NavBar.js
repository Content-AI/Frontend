    ...
    <>      
      ...
      <div className='p-2 hidden sm:block'>
        ...
        <div className="sm:flex sm:items-center sm:p-2 hidden">
          ...
          <Button sx={{ textTransform: 'none', width: "161px", color: "white", backgroundColor: "blue" }} variant="contained">
            <BsCheckCircle className="text-[#FFFFFF] mr-3" size={16} /> Upgrade to Pro
          </Button>
        </div>
                      ...
                      <div className="mt-[5vh] ">
                          ...
                          setHovered(!isHovered)
                              ...
                              <div  className='flex mb-4  hover:text-blue-500 cursor-pointer'>
                                ...
                                <div>
                                  <p className="text-[15px]  ml-[10px] font-helv">Settings</p>
                                </div>
                              </div>
                            </Link>
                          <div className='flex mb-4  hover:text-blue-500 cursor-pointer'>
                          ...
                          <div className='flex mb-4  hover:text-blue-500 cursor-pointer'>
                            ...
                            <div>
                              <p className="text-[15px]  ml-[10px] font-helv">Search</p>
                            </div>
                          </div>                      
                              <Link to="/logout" onClick={() =>{
                                ...
                                <div className='mr-2'>
                                  ...
                                  <div>
                                    <p className="text-[15px]  ml-[10px] font-helv">Logout</p>
                                  </div>
                                </div>
                              </Link>
                          </div>
